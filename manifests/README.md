...
- The profile also records the observed `captureLogs.extraEnv` setting `CLICKHOUSE_LOGS_DATABASE=posthog`; this runtime override was absent from the former HelmRelease values and must not disappear on a fresh deployment.
